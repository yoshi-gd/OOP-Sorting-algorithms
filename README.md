...
## Results:
● A working program that has multiple different sorting algorithms that can be imported to be used seperately or used as a program to read from and write to .txt files return
● Knowledge on how sorting algorithms like Heap Sort or Merge Sort work return
